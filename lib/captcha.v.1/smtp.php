...
function SendMail($frommail,$tomail,$subject,$message,$fromfullname="laptrinhwebphp.com")
{
      ...
      $smtp_host 		= 'smtp.gmail.com';//Dia chi mail server
      $admin_email 		= 'hodieu@gmail.com';//User duoc khai bao tren mail server
      $smtp_username 	= 'hodieu@gmail.com';//User duoc khai bao tren mail server
      $smtp_password 	= '@#Hongocdieu$';//Pass cua email nay
